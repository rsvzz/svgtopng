...
ItemFile *item_file_new(void) { return g_object_new(ITEM_FILE_TYPE, NULL); }

void item_file_set_data(ItemFile *self, const char *path, const char *name,
...
STATUS item_file_get_check(ItemFile *self) { return self->status; }
